...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var placeholder = messageInput.dataset.placeholder;

  // Mostrar el placeholder cuando el elemento está vacío
  if (!messageInput.textContent.trim()) {
    messageInput.textContent = placeholder;
  }

  // Cambiar el contenido al hacer clic en el elemento
  messageInput.addEventListener('click', function () {
    if (messageInput.textContent.trim() === placeholder) {
      messageInput.textContent = '';
    }
  });

  // Restaurar el placeholder cuando el elemento está vacío y pierde el foco
